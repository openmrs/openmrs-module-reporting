 ...
 * Evaluated Obs Query
 */
public class EvaluatedObsQuery extends EvaluatedQuery<ObsQuery> {
	 ...
	 * Full Constructor
	 */
    public EvaluatedObsQuery(ObsQuery definition, EvaluationContext context) {
