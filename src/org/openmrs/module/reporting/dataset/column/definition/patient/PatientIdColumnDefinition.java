 ...
 * Patient ID Column
 */
public class PatientIdColumnDefinition extends PatientPropertyColumnDefinition {
	 ...
	 * Default Constructor
	 */
	public PatientIdColumnDefinition() {
		super();
	}
	 ...
	 */
	public PatientIdColumnDefinition(String name) {
		super(name);
	}
	 ...
	 */
	public PatientIdColumnDefinition(String name, ColumnConverter transform) {
