...
/**
 * Obs-Patient Join Column Definition
 */
public class ObsPatientColumnDefinition extends JoinColumnDefinition<PatientColumnDefinition> implements ObsColumnDefinition {
	 ...
	 * Default Constructor
	 */
	public ObsPatientColumnDefinition() {
		super();
	}
	 ...
	 */
	public ObsPatientColumnDefinition(PatientColumnDefinition definition) {
		super(definition);
	}
