 ...
 * Encounter ID Column
 */
public class EncounterIdColumnDefinition extends EncounterPropertyColumnDefinition {
	 ...
	 * Default Constructor
	 */
	public EncounterIdColumnDefinition() {
		super();
	}
	 ...
	 */
	public EncounterIdColumnDefinition(String name) {
		super(name);
	}
	 ...
	 */
	public EncounterIdColumnDefinition(String name, ColumnConverter transform) {
