 ...
 */
public class EncounterFormColumnDefinition extends EncounterPropertyColumnDefinition {
	 ...
	 * Default Constructor
	 */
	public EncounterFormColumnDefinition() {
		super();
	}
	 ...
	 */
	public EncounterFormColumnDefinition(String name) {
		super(name);
	}
	 ...
	 */
	public EncounterFormColumnDefinition(String name, ColumnConverter transform) {
