...
/**
 * Indicates that a ColumnDefinition can be used within a row-per-person DataSetDefinition
 */
public interface PersonColumnDefinition extends PatientColumnDefinition {
