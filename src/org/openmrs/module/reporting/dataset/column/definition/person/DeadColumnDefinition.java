 ...
 * Dead Column
 */
public class DeadColumnDefinition extends PersonPropertyColumnDefinition {
	 ...
	 */
	public DeadColumnDefinition(String name) {
		super(name);
	}
	 ...
	 */
	public DeadColumnDefinition(String name, ColumnConverter transform) {
