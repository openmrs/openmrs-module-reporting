 ...
 */
public class EncounterLocationColumnDefinition extends EncounterPropertyColumnDefinition {
	 ...
	 * Default Constructor
	 */
	public EncounterLocationColumnDefinition() {
		super();
	}
	 ...
	 */
	public EncounterLocationColumnDefinition(String name) {
		super(name);
	}
	 ...
	 */
	public EncounterLocationColumnDefinition(String name, ColumnConverter transform) {
