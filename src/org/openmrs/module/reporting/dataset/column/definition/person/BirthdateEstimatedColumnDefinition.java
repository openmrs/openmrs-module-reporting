 ...
 */
public class BirthdateEstimatedColumnDefinition extends PersonPropertyColumnDefinition {
	 ...
	 * Default Constructor
	 */
	public BirthdateEstimatedColumnDefinition() {
		super();
	}
	 ...
	 */
	public BirthdateEstimatedColumnDefinition(String name) {
		super(name);
	}
	 ...
	 */
	public BirthdateEstimatedColumnDefinition(String name, ColumnConverter transform) {
