 ...
 */
public class CauseOfDeathColumnDefinition extends PersonPropertyColumnDefinition {
	 ...
	 * Default Constructor
	 */
	public CauseOfDeathColumnDefinition() {
		super();
	}
	 ...
	 */
	public CauseOfDeathColumnDefinition(String name) {
		super(name);
	}
	 ...
	 */
	public CauseOfDeathColumnDefinition(String name, ColumnConverter transform) {
