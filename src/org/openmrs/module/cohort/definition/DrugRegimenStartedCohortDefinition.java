 ...
 * 
 */
public class DrugRegimenStartedCohortDefinition extends BaseCohortDefinition {
	...
	@ConfigurationProperty(required=false)
	private Boolean startedFirstLineOnly = false;
	 ...
	 * Default constructor
	 */
	public DrugRegimenStartedCohortDefinition() {
		super();
	}
	...
	public Boolean getStartedFirstLineOnly() {
		return startedFirstLineOnly;
	}

	public void setStartedFirstLineOnly(Boolean startedFirstLineOnly) {
		this.startedFirstLineOnly = startedFirstLineOnly;
	}
