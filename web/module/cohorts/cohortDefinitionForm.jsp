...
<openmrs:require privilege="Manage Cohort Definitions" otherwise="/login.htm" redirect="/module/reporting/index.htm" />
...
<div id="page">
	...
	<div id="container">
		...
		<div id="cohort-definition-basic-tab">
			...
			<springform:form id="saveForm" commandName="cohortDefinition" method="POST">
