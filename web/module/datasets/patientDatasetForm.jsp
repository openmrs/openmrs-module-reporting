...
<openmrs:require privilege="Manage Data Set Definitions" otherwise="/login.htm" redirect="index.htm" />
<%@ include file="../localHeader.jsp"%>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<link type="text/css"
	href="${pageContext.request.contextPath}/moduleResources/datasetbuilder/css/smoothness/jquery-ui-1.7.1.custom.css"
	rel="stylesheet" />
<link type="text/css"
	href="${pageContext.request.contextPath}/moduleResources/datasetbuilder/css/dataset/customStyle.css"
	rel="stylesheet" />
<script type="text/javascript" language="javascript"
	src="${pageContext.request.contextPath}/moduleResources/datasetbuilder/js/jquery.js"></script>
<script type="text/javascript" language="javascript"
	src="${pageContext.request.contextPath}/moduleResources/datasetbuilder/js/jquery.dataTables.js"></script>
<style type="text/css" title="currentStyle">
@import
	"${pageContext.request.contextPath}/moduleResources/datasetbuilder/css/demo_page.css"
	;

@import
	"${pageContext.request.contextPath}/moduleResources/datasetbuilder/css/demo_table.css"
	;
</style>
...
<title>Create Patient Dataset</title>
</head>
...
By: <a href="#">Patient ID</a> </b></span> <span id="export-option"><b>Export
As: </b><a href="#">CSV</a> , <a href="#">TSV</a>, <a href="#">XML</a></span></div>
...
<div id="pagination" align="center"><span>Page: <b>1</b> <a
	href="#">3</a> <a href="#">4</a> <a href="#">more..</a></span></div>
