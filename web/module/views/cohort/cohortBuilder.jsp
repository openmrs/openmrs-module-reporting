...
<script type="text/javascript">
	...
	function classFilterTemplate(concept) {
		if (concept.className == 'Program') {
			...
			str += '<input type="hidden" name="filterClass" value="org.openmrs.cohort.definition.ProgramCohortDefinition" />';
			...
			var str = '<form method="post" action="cohortBuilder.form">';
			str += '<input type="hidden" name="method" value="addDynamicFilter"/>';
			str += '<input type="hidden" name="filterClass" value="org.openmrs.cohort.definition.DrugOrderCohortDefinition" />';
	...
	function obsFilterTemplate(concept) {
		...
		var str = '<form method="post" action="cohortBuilder.form">';
		str += '<input type="hidden" name="method" value="addDynamicFilter"/>';
		str += '<input type="hidden" name="filterClass" value="org.openmrs.cohort.definition.ObsCohortDefinition" />';
	...
	function obsValueFilterTemplate(concept) {
		var str = '<form method="post" action="cohortBuilder.form">';
		str += '<input type="hidden" name="method" value="addDynamicFilter"/>';
		str += '<input type="hidden" name="filterClass" value="org.openmrs.cohort.definition.ObsPatientCohortDefinition" />';
		...
		<c:forEach var="shortcut" items="${model.shortcuts}" varStatus="status">
			<span style="padding: 3px 0px; margin: 0px 3px; background-color: #ffffaa; border: 1px black solid">
				<c:if test="${shortcut.concrete}">
					<a href="cohortBuilder.form?method=addFilter&filter_id=${shortcut.cohortDefinition.id}"><spring:message code="${shortcut.label}"/></a>
				</c:if>
				<c:if test="${!shortcut.concrete}">
	...
	<div id="cohortSearchTabContent" style="border: 1px black solid; border-top: none; padding: 4px 5px 2px 10px;">
			...
			<div id="searchTab_logic_content" style="display: none">
				<div style="background: #f6f6f6; border: 1px #808080 solid; padding: 0.5em; margin: 0.5em">
					<form method="post" action="cohortBuilder.form">
						<input type="hidden" name="method" value="addDynamicFilter"/>
						<input type="hidden" name="filterClass" value="org.openmrs.reporting.LogicCohortDefinition" />
		...
		<div id="searchTab_attribute_content" style="display: none">
			<div style="background: #f6f6f6; border: 1px #808080 solid; padding: 0.5em; margin: 0.5em">
				<form method="post" action="cohortBuilder.form">
					<input type="hidden" name="method" value="addDynamicFilter"/>
					<input type="hidden" name="filterClass" value="org.openmrs.cohort.definition.PatientCharacteristicCohortDefinition" />
			...
			<div style="background: #f6f6f6; border: 1px #808080 solid; padding: 0.5em; margin: 0.5em">
				<form method="post" action="cohortBuilder.form">
					<input type="hidden" name="method" value="addDynamicFilter"/>
					<input type="hidden" name="filterClass" value="org.openmrs.cohort.definition.PersonAttributeFilter" />
		...
		<div id="searchTab_encounter_content" style="display: none">
			<div style="background: #f6f6f6; border: 1px #808080 solid; padding: 0.5em; margin: 0.5em">
				...
				<form method="post" action="cohortBuilder.form">
					<input type="hidden" name="method" value="addDynamicFilter"/>
					<input type="hidden" name="filterClass" value="org.openmrs.cohort.definition.EncounterCohortDefinition" />
			...
			<div style="background: #f6f6f6; border: 1px #808080 solid; padding: 0.5em; margin: 0.5em">
				...
				<form method="post" action="cohortBuilder.form">
					<input type="hidden" name="method" value="addDynamicFilter"/>
					<input type="hidden" name="filterClass" value="org.openmrs.cohort.definition.LocationCohortDefinition" />
		...
		<div id="searchTab_program_content" style="display: none">
			<div style="background: #f6f6f6; border: 1px #808080 solid; padding: 0.5em; margin: 0.5em">
				<form method="post" action="cohortBuilder.form">
					<input type="hidden" name="method" value="addDynamicFilter"/>
					<input type="hidden" name="filterClass" value="org.openmrs.cohort.definition.ProgramStateCohortDefinition" />
		...
		<div id="searchTab_drugOrder_content" style="display: none">
			...
			<div style="background: #f6f6f6; border: 1px #808080 solid; padding: 0.5em; margin: 0.5em">
				<form method="post" action="cohortBuilder.form" onSubmit="removeHiddenDivs()">
					<input type="hidden" name="method" value="addDynamicFilter"/>
					<input type="hidden" name="filterClass" value="org.openmrs.cohort.definition.DrugOrderCohortDefinition" />
			...
			<div style="background: #f6f6f6; border: 1px #808080 solid; padding: 0.5em; margin: 0.5em">
				<form method="post" action="cohortBuilder.form">
					<input type="hidden" name="method" value="addDynamicFilter"/>
					<input type="hidden" name="filterClass" value="org.openmrs.cohort.definition.DrugOrderStopCohortDefinition" />
	...
	<div id="cohort_builder_actions" style="position: relative; border: 1px black solid">
		...
		<span style="position: relative">
			<div id="webReportPopupMenu" style="width: 35em; border: 1px solid black; background-color: #f0f0a0; position: absolute; bottom: 0px; padding-right: 1.2em; z-index: 1; display: none">
				...
				<ul>
					<openmrs:forEachRecord name="reportDefinitionXml">
						<form id="${record.reportDefinitionId}" method="post" action="admin/reports/runReport.form">
							<input type="hidden" name="reportId" value="${record.reportDefinitionId}"/>
