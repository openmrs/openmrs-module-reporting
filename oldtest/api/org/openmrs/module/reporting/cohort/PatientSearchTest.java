...
import org.openmrs.module.reporting.cohort.definition.toreview.ObsCohortDefinition;
...
public class PatientSearchTest extends BaseContextSensitiveTest {
	...
	public void shouldParameters() throws Exception {
		...
		Parameter p = new Parameter("withinLastDays", "How many days?", Integer.class, null, 30);
