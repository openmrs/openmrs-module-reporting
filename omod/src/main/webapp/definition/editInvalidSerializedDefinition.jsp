				...
				<tr>
					<td valign="top">
						<ul>
							...
							<li>
								<label class="desc" for="type"><spring:message code="reporting.datasets.type"/></label>
								<input type="text" id="type" tabindex="4" name="type" value="${definition.type}" size="50"/>
							</li>
							<li>
								<label class="desc" for="subtype"><spring:message code="reporting.definition.subtype"/></label>
								<input type="text" id="subtype" tabindex="5" name="subtype" value="${definition.subtype}" size="50"/>
							</li>
							<li>
								<label class="desc" for="type"><spring:message code="reporting.definition.serialization"/></label>
