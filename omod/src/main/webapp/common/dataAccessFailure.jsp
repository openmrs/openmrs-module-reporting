...
<div style="margin: 10px;">
	...
	<% 
		...
		try {
			...
			if (exception != null) {			
				out.println("<li>Stacktrace: " + 
						"<a href=\"#\" onclick=\"showOrHide()\" id=\"toggleLink\" style=\"font-size: 12px;\">Show stack trace</a><br/>");
			}
			%>		
			...
			<%
				...
				if (exception.getMessage() != null) { 
					out.println("<pre id='exceptionMessage'><h3>" + Encode.forHtml(exception.getMessage()) + "</h3></pre>");
				}
				if (exception != null) {
