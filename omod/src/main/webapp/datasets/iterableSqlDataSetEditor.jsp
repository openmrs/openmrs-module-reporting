...
<c:url value="/module/reporting/datasets/iterableSqlDataSetEditor.form" var="pageUrlWithUuid">
	<c:param name="uuid" value="${definition.uuid}" />
</c:url>

<c:set var="pageUrl" value="/module/reporting/datasets/iterableSqlDataSetEditor.form?uuid=uuid"/>
    ...
    <div id="container">
        <c:choose>
            <c:when test="${definition.id == null}">
                ...
                <b class="boxHeader"><spring:message code="reporting.IterableSqlDataSetDefinition"/></b>
                <div class="box">
                    <openmrs:portlet url="baseMetadata" id="baseMetadata" moduleId="reporting"
                                     parameters="type=org.openmrs.module.reporting.dataset.definition.IterableSqlDataSetDefinition|size=380|mode=edit|dialog=false|cancelUrl=${pageContext.request.contextPath}/module/reporting/definition/manageDefinitions.form?type=org.openmrs.module.reporting.dataset.definition.DataSetDefinition|successUrl=${pageUrl}"/>
                </div>
                            ...
                            <div style="margin: 0.1em; width:100%;">
                                ...
                                <div class="box">
                                    <form method="post" action="iterableSqlDataSetDefinitionAssignQueryString.form">
                                        ...
                                        <textarea id="editBox" rows="18" cols="50" id="queryString"
                                                  name="queryString">${definition.sql}</textarea>
                                        <br/>
                                        <span>
											<input type="submit" value="<spring:message code="reporting.button.save"/>"/>
											<input id="closeButton" type="button" value="<spring:message code="reporting.button.close"/>"
											...
											<span style="float: right">
												<button id="previewButton"><img id="play"
                                                                                src='<c:url value="/images/play.gif"/>'
                                                                                border="0"/>&nbsp;&nbsp;<spring:message code="reporting.button.preview"/></button>
											</span>
										</span>
                                    </form>
                                </div>
