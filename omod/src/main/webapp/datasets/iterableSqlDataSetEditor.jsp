								...
								<div class="box">
									<form method="post" action="iterableSqlDataSetDefinitionAssignQueryString.form">
										...
										<span>
											...
											<input id="closeButton" type="button" value="Close" onClick="window.location='${pageContext.request.contextPath}/module/reporting/definition/manageDefinitions.form?type=org.openmrs.module.reporting.dataset.definition.DataSetDefinition';"/>
