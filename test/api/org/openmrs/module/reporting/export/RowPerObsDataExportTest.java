 ...
 */
package org.openmrs.module.reporting.export;
...
/**
 * Tests the {@link RowPerObsDataExport} class TODO clean up, finish, add methods to
 * this test class
 */
public class RowPerObsDataExportTest extends BaseContextSensitiveTest {
	...
	public void shouldExportMoreThanRowPerPatient() throws Exception {
		...
		// FIXME Need to migrate ObsDataExport somehow
		Assert.fail("ObsDataExport was not moved over from the reporting-spring branch");
		
		DataExportReportObject export = new DataExportReportObject();
		//ObsDataExport export = new ObsDataExport();
