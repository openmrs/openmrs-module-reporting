...
public class PepfarReportSerializationTest extends BaseContextSensitiveTest {
	...
	public void shouldPepfarStaticCohortSerialization() throws Exception {
		...
		Parameter startDateParam = new Parameter("report.startDate", "When does the report period start?", Date.class, null,false);
		Parameter endDateParam = new Parameter("report.endDate", "When does the report period end?", Date.class, null,false);
		Parameter locationParam = new Parameter("report.location", "For which clinic is this report?", Location.class, null,false);
