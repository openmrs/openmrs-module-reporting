 ...
 */
public class PatientCharacteristicCohortDefinitionEvaluatorTest extends BaseContextSensitiveTest {
	...
	public void getHandlerForType_shouldReturnAnEmptyListIfNoClassesCanHandleThePassedType() throws Exception {
		PatientCharacteristicCohortDefinition d = new PatientCharacteristicCohortDefinition();
		d.setGender("M");
