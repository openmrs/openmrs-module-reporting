...
public class ConvertedEncounterDataEvaluatorTest extends BaseModuleContextSensitiveTest {
	...
	/**
	 * @see org.openmrs.module.reporting.data.patient.evaluator.ConvertedPatientDataEvaluator#evaluate(org.openmrs.module.reporting.data.patient.definition.PatientDataDefinition, EvaluationContext)
