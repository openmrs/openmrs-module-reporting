...
public class MockLogicCriteria implements LogicCriteria {
	...
	/**
	 * @see LogicCriteria#appendExpression(op.Operator, String)
	 */
	...
	/**
	 * @see LogicCriteria#first(Integer, String)
	 */
	...
	/**
	 * @see LogicCriteria#first(Integer)
	 */
	...
	/**
	 * @see LogicCriteria#first(String)
	 */
	...
	/**
	 * @see LogicCriteria#in(Collection)
	 */
	...
	/**
	 * @see LogicCriteria#last(Integer)
	 */
	...
	/**
	 * @see LogicCriteria#setLogicParameters(Map)
	 */
