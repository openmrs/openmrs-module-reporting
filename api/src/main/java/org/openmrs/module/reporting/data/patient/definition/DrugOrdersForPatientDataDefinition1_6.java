...
public class DrugOrdersForPatientDataDefinition1_6 extends BaseDataDefinition implements DrugOrdersForPatientDataDefinition {
	 ...
	 * Default Constructor
	 */
	public DrugOrdersForPatientDataDefinition1_6() {
		super();
	}
	 ...
	 */
	public DrugOrdersForPatientDataDefinition1_6(String name) {
		super(name);
	}
