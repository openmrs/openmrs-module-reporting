...
public class ObsOnSameDateEncounterDataDefinition extends BaseDataDefinition implements EncounterDataDefinition {
    ...
    public ObsOnSameDateEncounterDataDefinition() {
        super();
    }

    public ObsOnSameDateEncounterDataDefinition(String name) {
        super(name);
    }
