...
public class HibernateReportDAO implements ReportDAO {
	...
	/**
	 * Return a list of {@link ReportDesign}s for the passed {@link ReportDefinition} and
	 * {@link ReportRenderer} class, optionally including those that are retired
	 * 
	...
	public List<ReportDesign> getReportDesigns(ReportDefinition reportDefinition,
	        Class<? extends ReportRenderer> rendererType, boolean includeRetired) throws DAOException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<ReportRequest> getReportRequests(ReportDefinition reportDefinition, Date requestOnOrAfter,
	        Date requestOnOrBefore, Integer mostRecentNum, Status... statuses) {
